...
rda(BacSurf.dist ~ EnviS.dist + GeoS.dist)
rda(BacSurf.dist ~ HNFSurf.dist + EnviS.dist + GeoS.dist)
anova.cca(rda(BacSurf.dist ~ HNFSurf.dist + Condition(EnviS.dist + GeoS.dist)))
anova.cca(rda(BacSurf.dist ~ EnviS.dist + Condition(HNFSurf.dist + GeoS.dist)))
anova.cca(rda(BacSurf.dist ~ GeoS.dist + Condition(EnviS.dist + HNFSurf.dist)))
...
varpart(BacDCM.dist, HNFDCM.dist, EnviD.dist, GeoD.dist)
